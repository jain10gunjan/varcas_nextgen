    ...
    <div>
      ...
      <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
        <div className="max-w-3xl mb-10 lg:mb-14">
          <h2 className="text-gray-900 font-semibold text-2xl md:text-4xl md:leading-tight">Our approach</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          ...
          <div>
            ...
            <div className="flex gap-x-5 ms-1">
              ...
              <div className="grow pt-0.5 pb-8 sm:pb-12">
                <p className="text-sm lg:text-base text-neutral-400">
                  <span className="text-gray-900">Product Development and Testing:</span>
            ...
            <div className="flex gap-x-5 ms-1">
              ...
              <div className="grow pt-0.5 pb-8 sm:pb-12">
                <p className="text-sm md:text-base text-neutral-400">
                  <span className="text-gray-900">Marketing and Promotion:</span>
            ...
            <div className="flex gap-x-5 ms-1">
              ...
              <div className="grow pt-0.5 pb-8 sm:pb-12">
                <p className="text-sm md:text-base text-neutral-400">
                  <span className="text-gray-900">Launch and Optimization:</span>
                  Launch your digital products or services to the market, closely monitoring their performance and user feedback.
                </p>
              </div>
            </div>

            {/* <a className="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#b21fdb] font-medium text-sm text-neutral-100 rounded-full focus:outline-none" href="#">
