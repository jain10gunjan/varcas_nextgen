...
const Header3 = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const store = new SteinStore('https://api.steinhq.com/v1/storages/66936c704d11fd04f013470a');
                    ...
                    <div>
                        ...
                        <div className="mt-4 md:mb-12 max-w-2xl">
                            ...
                            <p className="text-gray-600">
                                Varcas NexGen Digital Marketing is a cutting-edge digital marketing agency dedicated to helping businesses thrive in the online world. With a team of skilled professionals and innovative strategies, we offer a comprehensive range of services tailored to meet your specific needs and goals. 
                            </p>
                        </div>
                        ...
                        <blockquote className="hidden md:block relative max-w-sm">
                            ...
                            <div className="relative z-10">
                                <p className="text-xl italic text-gray-800">
                                    Empowering Businesses Globally | Digital Marketing Expert | Driving Profitable Growth & Brand Recognition
                                </p>
                            </div>
                            ...
                            <footer className="mt-3">
                                <div className="flex items-center">
                                    <div className="flex-shrink-0">
                                        <img className="size-8 rounded-full" src="https://media.licdn.com/dms/image/D4D03AQHKOAnZa0Iguw/profile-displayphoto-shrink_800_800/0/1714896273422?e=1726704000&v=beta&t=mE6gtxMuqL49gZS-ab60HFRU8kjrCPgxelQkfrp4RRQ" alt="Founder Image" />
                                    </div>
                                    <div className="grow ms-4">
                                        <div className="font-semibold text-gray-800">Gopal Kushwaha</div>
                                        <div className="text-xs text-gray-500">Founder, CEO | Varcas NexGen</div>
                                    </div>
                                </div>
                            </footer>
                        </blockquote>
                            ...
                            <div className="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                                <div className="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg">
                                    <div className="text-center">
                                        <h1 className="block text-2xl font-bold text-gray-800">Get In Touch</h1>
                                    </div>
                                    <div className="mt-5">
    ...
    <img className='md:w-48 w-24' src={`./trineenterprise-removebg-preview.png`}/>
              <img className='md:w-48 w-24' src={`./vasudadevcon-removebg-preview.png`}/>
              <img className='md:w-48 w-24' src={`./DomaFabricators-removebg-preview.png`}/>
    </div>
            </div>
            <Toaster/>
