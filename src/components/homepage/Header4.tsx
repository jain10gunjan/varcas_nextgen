...
const Header4 = () => {
  return (
    <div className="relative bg-gradient-to-bl from-orange-100 via-transparent mt-28">
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 bg-gradient-to-bl from-orange-100 via-transparent">
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center py-12">
          <div>
            ...
            <div className="mt-7 gap-3 w-full sm:inline-flex">
