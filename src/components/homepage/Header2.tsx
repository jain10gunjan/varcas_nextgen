...
export default function Header2() {
  ...
  return (
    <>
    <div className="font-heading font-medium relative bg-blueGray-100">
      <nav className="flex justify-between px-6 lg:px-12 py-8">
        <div className="flex w-full items-center justify-between">
          <div className="flex items-center">
            <button onClick={() => setMobileNavOpen(!mobileNavOpen)} className="hidden lg:block focus:outline-none">
              <svg width="25" height="16" viewBox="0 0 25 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="25" height="2" fill="black"></rect>
                <rect y="14" width="25" height="2" fill="black"></rect>
              </svg>
            </button>
            <div className="hidden lg:block w-px h-10 bg-gray-200 bg-opacity-50 mx-8 md:ml-14 md:mr-12"></div>
            <a href="#">
              <img className="h-12" src="https://shuffle.dev/uinel-assets/logos/uinel-white-black.svg" alt="" />
            </a>
          </div>
        ...
        <button onClick={() => setMobileNavOpen(!mobileNavOpen)} className="self-center xl:hidden text-gray-400 hover:text-gray-500 focus:outline-none">
          <svg width="25" height="16" viewBox="0 0 25 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="25" height="2" fill="black"></rect>
            <rect y="14" width="25" height="2" fill="black"></rect>
          </svg>
      ...
      <div className={`${mobileNavOpen ? 'block' : 'hidden'} fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50`}>
        ...
        <nav className="relative flex flex-col py-8 h-full w-full bg-white overflow-y-auto">
          <div className="flex items-center pl-16 mb-8">
            <a className="text-2xl text-gray-800 font-bold" href="#">
              <img className="h-12" src="https://shuffle.dev/uinel-assets/logos/uinel-gray-black.svg" alt="" />
            </a>
          </div>
        ...
        <button onClick={() => setMobileNavOpen(!mobileNavOpen)} className="absolute top-5 p-6 right-5">
    ...
    <section>
      <div className="bg-blueGray-100 rounded-b-9xl">
        <div className="container px-4 mx-auto">
          <div className="relative pt-24 mb-16 xl:mb-0 z-20">
            <span className="block mb-9 font-medium tracking-widest uppercase text-center text-sm text-gray-300">
              Better communication and work
            </span>
            <h1 className="max-w-lg mx-auto font-heading font-medium text-center text-6xl md:text-10xl leading-tight">
              Stay home. Create design
            </h1>
          </div>
        </div>
        <div className="relative xl:-mt-32 max-w-max">
          <img src="https://shuffle.dev/uinel-assets/images/heroes/widget2.png" alt="" />
        </div>
      </div>
    </section>
  </>
